...
import { EventsCompanionUiClient } from './client/EventsCompanionUiClient.js';
import { NewOrderPage } from './client/pages/NewOrderPage.js';

export class EventsCompanionUiDriver implements EventsCompanionDriver {
  private readonly client: EventsCompanionUiClient;

  constructor(baseUrl: string, browser: Browser) {
    this.client = new EventsCompanionUiClient(baseUrl, browser);
  }
