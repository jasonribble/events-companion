...
import { GoToEventsCompanion } from './usecases/GoToEventsCompanion.js';

export class EventsCompanionDsl {
  constructor(
    private readonly driver: EventsCompanionDriver,
    private readonly context: UseCaseContext,
  ) {}

  goToEventsCompanion(): GoToEventsCompanion {
    return new GoToEventsCompanion(this.driver, this.context);
  }
